	...
	<div class="panel-body">
		<form id="renterUpdateForm" action="<?php echo base_url('super_admin/update_renter'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="col-md-8">
                <div class="form-group">
                    <select name="renter_division" class="form-control">
                        ...
                        <option value="<?php echo $updateData->renter_division; ?>" selected="selected"><?php echo $updateData->renter_division; ?></option>
                ...
                <div class="form-group">
                    <input value="<?php echo $updateData->renter_district; ?>" type="text" name="renter_district" class="form-control" placeholder="জেলা">
                </div>
                <div class="form-group">
			...
			<div class="form-group" style="margin-top: 30px;">
			    ...
			    <button type="submit" id="renter_update_form_submit" class="btn btn-primary">Submit</button>
			</div>
		</form>
	</div>
</div>