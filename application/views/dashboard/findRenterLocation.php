    ...
    <div class="container well" style="max-width: 600px; margin-top:10%; margin-left:auto; margin-right: auto; box-shadow: 0 5px 15px rgba(0,0,0,.5);">
        ...
        <div style="padding: 30px;">    
            <form id="search_renter_form" action="<?php echo base_url('super_admin/findRenterLocationFromDB');?>" method="post">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <div class="input-group-addon search_renter_btn" style="cursor: pointer;"><span class="glyphicon glyphicon-search"></span></div>
                </div>
              </div>
            </form>
        </div>
